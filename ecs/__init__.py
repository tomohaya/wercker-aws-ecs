...
class ECSService(object):
    ...
    def register_task_definition(self, family, role_arn, execution_role_arn, network_mode, requires_compatibilities ,file):
        """
        ...
        response = self.client.register_task_definition(family=family, taskRoleArn=role_arn, executionRoleArn=execution_role_arn, networkMode=network_mode, requiresCompatibilities=requires_compatibilities, containerDefinitions=container_definitions)
